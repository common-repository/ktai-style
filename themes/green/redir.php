...
if (ks_redir_has('full_url')) : 
	?><div style="<?php echo $ks_settings['title_style']; ?>"><h2><?php _e('Confirm connecting to external sites', 'ktai_style'); ?></h2></div>
...
<?php else: // ks_redir_has ?>
	<div style="<?php echo $ks_settings['title_style']; ?>"><h2><?php _e('Error linking to external sites', 'ktai_style'); ?></h2></div>
